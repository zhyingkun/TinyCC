  ...
  switch (tok) {
    ...
    case TOK_ASMDIR_type: {
      ...
      if (!strcmp(newtype, "function") || !strcmp(newtype, "STT_FUNC")) {
        ...
        tcc_warning("change type of '%s' from 0x%x to '%s' ignored", get_tok_str(sym->v, NULL), sym->type.t, newtype);
...
static void subst_asm_operands(ASMOperand* operands, int nb_operands, CString* out_str, CString* in_str) {
